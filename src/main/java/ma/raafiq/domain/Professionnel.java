...
public class Professionnel implements Serializable {
    ...
    public Professionnel adresse(String adresse) {
    ...
    public Professionnel benef2019(Integer benef2019) {
    ...
    public Professionnel benef2020(Integer benef2020) {
    ...
    public Professionnel cin(String cin) {
        this.setCin(cin);
        return this;
    }
    ...
    public Professionnel dateCreation(Instant dateCreation) {
    ...
    public Professionnel dateModification(Instant dateModification) {
    ...
    public Professionnel dateNaissance(LocalDate dateNaissance) {
    ...
    public Professionnel etat(Integer etat) {
        this.setEtat(etat);
        return this;
    }
    ...
    public Professionnel explicationRefus(String explicationRefus) {
    ...
    public Professionnel nbrEnfants(Integer nbrEnfants) {
    ...
    public Professionnel niveauScolarite(Integer niveauScolarite) {
    ...
    public Professionnel nomFr(String nomFr) {
        this.setNomFr(nomFr);
        return this;
    }
    ...
    public Professionnel numeroDossier(String numeroDossier) {
    ...
    public Professionnel prenomFr(String prenomFr) {
    ...
    public Professionnel selectionner(Integer selectionner) {
    ...
    public Professionnel sexe(Integer sexe) {
        this.setSexe(sexe);
        return this;
    }
    ...
    public Professionnel lieuTravailProfessionnel(String lieuTravailProfessionnel) {
    ...
    public Professionnel specialiteProfessionnel(Integer specialiteProfessionnel) {
    ...
    public Professionnel appUser(AppUser appUser) {
    ...
    public Professionnel enfant(Enfant enfant) {
    ...
    public Professionnel motifRefus(MotifRefus motifRefus) {
    ...
    public Professionnel province(Province province) {
