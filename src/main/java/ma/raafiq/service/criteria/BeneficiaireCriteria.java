...
/**
 * Criteria class for the {@link ma.raafiq.domain.Beneficiaire} entity. This class is used
 * in {@link ma.raafiq.web.rest.BeneficiaireResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /beneficiaires?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
public class BeneficiaireCriteria implements Serializable, Criteria {

    private static final long serialVersionUID = 1L;

    private StringFilter typeBeneficiare;
    ...
    private IntegerFilter autreBenef2019;

    private IntegerFilter autreBenef2020;

    private IntegerFilter relationFamiliale;
    ...
    public BeneficiaireCriteria(BeneficiaireCriteria other) {
        this.typeBeneficiare = other.typeBeneficiare == null ? null : other.typeBeneficiare.copy();
        ...
        this.autreBenef2019 = other.autreBenef2019 == null ? null : other.autreBenef2019.copy();
        this.autreBenef2020 = other.autreBenef2020 == null ? null : other.autreBenef2020.copy();
        this.relationFamiliale = other.relationFamiliale == null ? null : other.relationFamiliale.copy();
    ...
    @Override
    public BeneficiaireCriteria copy() {
        return new BeneficiaireCriteria(this);
    }

    public StringFilter getTypeBeneficiare() {
        return typeBeneficiare;
    }

    public StringFilter typeBeneficiare() {
        if (typeBeneficiare == null) {
            typeBeneficiare = new StringFilter();
        }
        return typeBeneficiare;
    }

    public void setTypeBeneficiare(StringFilter typeBeneficiare) {
    ...
    public IntegerFilter getAutreBenef2019() {
        return autreBenef2019;
    }

    public IntegerFilter autreBenef2019() {
        if (autreBenef2019 == null) {
            autreBenef2019 = new IntegerFilter();
        }
        return autreBenef2019;
    }

    public void setAutreBenef2019(IntegerFilter autreBenef2019) {
        this.autreBenef2019 = autreBenef2019;
    }

    public IntegerFilter getAutreBenef2020() {
        return autreBenef2020;
    }

    public IntegerFilter autreBenef2020() {
        if (autreBenef2020 == null) {
            autreBenef2020 = new IntegerFilter();
        }
        return autreBenef2020;
    }

    public void setAutreBenef2020(IntegerFilter autreBenef2020) {
        this.autreBenef2020 = autreBenef2020;
    }

    public IntegerFilter getRelationFamiliale() {
        return relationFamiliale;
    }

    public IntegerFilter relationFamiliale() {
        if (relationFamiliale == null) {
            relationFamiliale = new IntegerFilter();
        }
        return relationFamiliale;
    }

    public void setRelationFamiliale(IntegerFilter relationFamiliale) {
    ...
    public boolean equals(Object o) {
        ...
        final BeneficiaireCriteria that = (BeneficiaireCriteria) o;
        return (
            Objects.equals(typeBeneficiare, that.typeBeneficiare) &&
            ...
            Objects.equals(autreBenef2019, that.autreBenef2019) &&
            Objects.equals(autreBenef2020, that.autreBenef2020) &&
            Objects.equals(relationFamiliale, that.relationFamiliale) &&
    ...
    public String toString() {
        return "BeneficiaireCriteria{" +
            (typeBeneficiare != null ? "typeBeneficiare=" + typeBeneficiare + ", " : "") +
            (id != null ? "id=" + id + ", " : "") +
            ...
            (autreBenef2019 != null ? "autreBenef2019=" + autreBenef2019 + ", " : "") +
            (autreBenef2020 != null ? "autreBenef2020=" + autreBenef2020 + ", " : "") +
            (relationFamiliale != null ? "relationFamiliale=" + relationFamiliale + ", " : "") +
