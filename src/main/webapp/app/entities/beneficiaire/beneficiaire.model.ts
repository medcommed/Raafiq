...
export interface IBeneficiaire {
  ...
  lieuTravailProfessionnel?: string | null;
  specialiteProfessionnel?: number | null;
...
export class Beneficiaire implements IBeneficiaire {
  constructor(
    ...
    public lieuTravailProfessionnel?: string | null,
    public specialiteProfessionnel?: number | null,
