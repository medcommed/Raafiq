...
describe('AppRole Management Component', () => {
  let comp: AppRoleComponent;
  let fixture: ComponentFixture<AppRoleComponent>;
  let service: AppRoleService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'app-role', component: AppRoleComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(AppRoleComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.appRoles?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
