...
describe('MotifRefus Management Component', () => {
  let comp: MotifRefusComponent;
  let fixture: ComponentFixture<MotifRefusComponent>;
  let service: MotifRefusService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'motif-refus', component: MotifRefusComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(MotifRefusComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.motifRefuses?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
